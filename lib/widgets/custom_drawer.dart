        ...
        child: ListView(
          ...
          children: [
            UserAccountsDrawerHeader(
              ...
              accountName: const Text('مرحبا، المستخدم', style: TextStyle(fontWeight: FontWeight.bold)),
            ...
            _buildListTile(Icons.person, "الملف الشخصي", iconColor: AppTheme.navy, onTap: () {
            ...
            _buildListTile(Icons.assignment, "معاملاتي", iconColor: Colors.brown.shade700, onTap: () {
              Navigator.push(context, MaterialPageRoute(
            ...
            _buildListTile(Icons.directions_car, "مركباتي", iconColor: Colors.indigo, onTap: () {
              Navigator.push(context, MaterialPageRoute(
            ...
            _buildListTile(Icons.support_agent, "الشكاوى والاقتراحات", iconColor: Colors.green, onTap: () {
              Navigator.push(context, MaterialPageRoute(
                builder: (_) => const ComplaintsSuggestionsScreen(),
              ));
            }),
            _buildListTile(Icons.question_answer, "الأسئلة الشائعة", iconColor: Colors.blueGrey),
            _buildListTile(Icons.phone_in_talk, "تواصل مع دائرة السير", iconColor: Colors.teal, onTap: () {
              Navigator.push(context, MaterialPageRoute(
            ...
            _buildListTile(Icons.settings, "الإعدادات العامة", iconColor: Colors.deepPurple, onTap: () {
              Navigator.push(context, MaterialPageRoute(
