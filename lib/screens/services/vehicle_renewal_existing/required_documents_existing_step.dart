...
class RequiredDocumentsExistingStep extends StatefulWidget {
  final bool hasViolations;
  final Function(Map<String, File>) onStepCompleted;

  const RequiredDocumentsExistingStep({
    Key? key,
  ...
  @override
  State<RequiredDocumentsExistingStep> createState() => RequiredDocumentsExistingStepState();
}

class RequiredDocumentsExistingStepState extends State<RequiredDocumentsExistingStep> {
  ...
  bool validateDocuments() {
    List<String> requiredDocs = ["insurance_document".tr()];
    if (widget.hasViolations) {
      requiredDocs.add("violations_clearance_document".tr());
    }
