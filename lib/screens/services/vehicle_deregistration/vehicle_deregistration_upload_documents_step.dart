...
import 'vehicle_deregistration_required_documents_helper.dart';

class VehicleDeregistrationUploadDocumentsStep extends StatefulWidget {
  final Function(Map<String, File>) onStepCompleted;

  const VehicleDeregistrationUploadDocumentsStep({
    super.key,
    required this.onStepCompleted,
  });

  @override
  State<VehicleDeregistrationUploadDocumentsStep> createState() => VehicleDeregistrationUploadDocumentsStepState();
}

class VehicleDeregistrationUploadDocumentsStepState extends State<VehicleDeregistrationUploadDocumentsStep> {
  ...
  bool validateDocuments() {
    final requiredDocs = VehicleDeregistrationRequiredHelper.getRequiredDocuments();
