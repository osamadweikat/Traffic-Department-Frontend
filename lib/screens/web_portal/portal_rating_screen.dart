...
class _PortalRatingScreenState extends State<PortalRatingScreen> with TickerProviderStateMixin {
                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        Lottie.asset('assets/animations/star_effect.json', height: 70, repeat: true),
                    ...
                    Row(
                      ...
                      children: List.generate(5, (index) {
                        ...
                        final animation = Tween<double>(begin: 1.0, end: isSelected ? 1.4 : 1.05)
                            .animate(CurvedAnimation(parent: controller, curve: Curves.easeOutBack));

                        return GestureDetector(
                          onTap: () => _handleStarTap(index),
                          child: AnimatedBuilder(
                            animation: Listenable.merge([controller, _backgroundController]),
                            builder: (context, child) {
                              final scale = isSelected
                                  ? animation.value
                                  : 1.0 + (0.03 * (_backgroundController.value - 0.5).abs());
